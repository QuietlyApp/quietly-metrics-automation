...
describe('Test on-boarding in case of switching plan type after login, #onboarding_plan_switch#', function () {
    ...
    it('C287 Login with Free Plan, switch to Monthly pro, complete on-boarding and check the Plan type', async function() {
    ...
    it('C288 Login as Free Plan and switch to Annual pro', async function() {
        await common.goToLandingPage('Free');
        await common.signInWithGmail();
        await val.validatePlanType('Free');
    ...
    it('C289 Login with Monthly Pro Plan and switch to Free Plan', async function() {
    ...
    it('C290 Login with Monthly Pro Plan and switch to Annual Pro Plan', async function() {
        await common.goToLandingPage('Monthly Pro');
        await common.signInWithGmail();
        await val.validatePlanType('Monthly Pro');
        await common.onboardingChangePlan('Annual Pro');
    ...
    it('C291 Login with Annual Pro Plan and switch to Free Plan', async function() {
    ...
    it('C292 Login with Annual Pro Plan and switch to Monthly Pro Plan', async function() {
        await common.goToLandingPage('Annual Pro');
        await common.signInWithGmail();
        await val.validatePlanType('Annual Pro');
        await common.onboardingChangePlan('Monthly Pro');
