...
describe('Login Tests, #login_tests#', function () {
    ...
    it('C130: Log in as a new user with Monthly Pro plan and verify if the user is navigated to the pro plan', async function() {
    ...
    it('C131: Log in into "Quietly Insights" with Monthly Pro plan with non Google Analytics account', async function() {
        await common.goToLandingPage('Monthly Pro');
    ...
    it('C132: Log in as a new user with "Annual Pro plan" and verify if the user is navigated to the pro plan', async function() {
    ...
    it('C133: Log in into "Quietly Insights" with Annual Pro plan with non Google Analytics account', async function() {
        await common.goToLandingPage('Annual Pro');
        await common.signInWithGmail("quietlymedia@gmail.com", "N0morewaffles");
        await val.validatePlanType('Annual Pro');
        await common.logout("quietlymedia@gmail.com");
    ...
    it('C134: Log in as a new user with "Free plan" and verify if the user is navigated to the Free plan', async function() {
    ...
    it('C135: Log in into "Quietly Insights" with Free plan with non Google Analytics account', async function() {
        await common.goToLandingPage('Free');
        await common.signInWithGmail("quietlymedia@gmail.com", "N0morewaffles");
        await val.validatePlanType('Free');
        await common.logout("quietlymedia@gmail.com");
    ...
    it('C136: Verify whether the "Quietly Logo" on the pricing page navigates the user to the home page', async function() {
        await common.goToLandingPage('Monthly Pro');
